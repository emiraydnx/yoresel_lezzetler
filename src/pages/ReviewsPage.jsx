        ...
        <section className="space-y-6">
            <div>
                ...
                <p className="mt-3 max-w-3xl text-slate-600">
                    Firestore reviews collection icindeki onayli yorumlar kullanici bilgileriyle birlikte listelenir.
                </p>
            </div>
            ...
            {!loading && !reviews.length && (
                <p className="rounded border border-dashed bg-white p-4 text-sm text-slate-500">Henuz onayli yorum bulunmuyor.</p>
            )}
