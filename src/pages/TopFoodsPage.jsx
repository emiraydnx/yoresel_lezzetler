...
const TopFoodsPage = () => {
    ...
    return (
        <section className="space-y-6">
            <div>
                <p className="text-sm font-medium text-emerald-700">Lezzet siralamasi</p>
                <h1 className="mt-2 text-3xl font-bold text-slate-950">En Sevilen Lezzetler</h1>
                <p className="mt-3 max-w-3xl text-slate-600">
                    Firestore foods collection verileri averageRating, reviewCount ve featuredScore alanlarina gore siralanir.
                </p>
            </div>
            ...
            {!loading && !foods.length && (
                <p className="rounded border border-dashed bg-white p-4 text-sm text-slate-500">Gosterilecek lezzet bulunamadi.</p>
            )}
